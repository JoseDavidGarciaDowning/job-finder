            ...
            <div className="mb-8">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-5 h-5 bg-purple-800 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
          ...
          <div className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 p-4">
            <div className="max-w-md mx-auto flex items-center gap-4">
              <button
                ...
                className="w-12 h-12 border border-gray-200 rounded-xl flex items-center justify-center"
              >
              ...
              <button
                ...
                className="flex-1 bg-purple-800 text-white font-semibold py-3 px-6 rounded-xl hover:bg-purple-900 transition-colors"
              >
                APLICAR AHORA
              </button>
            </div>
